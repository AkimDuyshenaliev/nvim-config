...
if is_available "nvim-dap" then
  ...
  maps.n["<F17>"] = { function() require("dap").terminate() end, desc = "Debugger: Terminate" } -- Shift+F5
  -- maps.n["<F17>"] = { function() require("dap").disconnect() end, desc = "Debugger: Disconnect" } -- Shift+F5
  maps.n["<F21>"] = { -- Shift+F9
    function()
  ...
  -- maps.n["<leader>dQ"] = { function() require("dap").disconnect() end, desc = "Disconnect from Session (S-F5)" }
